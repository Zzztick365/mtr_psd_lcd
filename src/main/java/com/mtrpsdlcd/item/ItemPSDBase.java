					...
					if (this.item.isDoor) {
						...
						switch (this.type) {
							...
							case PSD_2_LCD7:
								...
								break;
							case PSD_2_LCD15:
								topBlock = Blocks.PSD_TOP_LCD15;
								break;
							case PSD_2_LCD19:
								topBlock = Blocks.PSD_TOP_LCD19;
								break;
							default:
						...
						world.setBlockState(topPos, this.type == EnumPSDAPGType.PSD_GLASS_LCD13 ? Blocks.PSD_TOP_LCD13.get().getDefaultState() : this.type == EnumPSDAPGType.PSD_GLASS_LCD14 ? Blocks.PSD_TOP_LCD14.get().getDefaultState() : this.type == EnumPSDAPGType.PSD_GLASS_LCD17 ? Blocks.PSD_TOP_LCD17.get().getDefaultState() : this.type == EnumPSDAPGType.PSD_GLASS_LCD21 ? Blocks.PSD_TOP_LCD21.get().getDefaultState() : this.type == EnumPSDAPGType.PSD_GLASS_LCD22 ? Blocks.PSD_TOP_LCD22.get().getDefaultState() : org.mtr.mod.Blocks.PSD_TOP.get().getDefaultState());
					}
	...
	private BlockState getBlockStateFromItem() {
		switch (this.type) {
			...
			case PSD_GLASS_LCD13:
				return Blocks.PSD_GLASS_LCD13.get().getDefaultState();
			case PSD_GLASS_LCD14:
				return Blocks.PSD_GLASS_LCD14.get().getDefaultState();
			case PSD_2_LCD2:
				switch (this.item) {
					case PSD_APG_DOOR:
			...
			case PSD_2_LCD15:
				switch (this.item) {
					case PSD_APG_DOOR:
						return Blocks.PSD_DOOR_LCD15.get().getDefaultState();
					case PSD_APG_GLASS:
						return Blocks.PSD_GLASS_2.get().getDefaultState();
				}
				break;
			case PSD_2_LCD19:
				switch (this.item) {
					case PSD_APG_DOOR:
						return Blocks.PSD_DOOR_LCD19.get().getDefaultState();
					case PSD_APG_GLASS:
						return Blocks.PSD_GLASS_2.get().getDefaultState();
				}
				break;
			case PSD_GLASS_LCD17:
				return Blocks.PSD_GLASS_LCD17.get().getDefaultState();
			case PSD_GLASS_LCD21:
				return Blocks.PSD_GLASS_LCD21.get().getDefaultState();
			case PSD_GLASS_LCD22:
				return Blocks.PSD_GLASS_LCD22.get().getDefaultState();
		}
